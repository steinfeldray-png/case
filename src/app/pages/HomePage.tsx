...
export default function HomePage() {
  ...
  return (
    <div className="bg-[#fffbfa] flex flex-col items-start px-5 md:px-[48px] relative size-full overflow-y-auto">
      {/* Header */}
            ...
            <div className="flex flex-col md:flex-row gap-[16px] md:gap-[12px] items-start md:items-end w-full">
              ...
              <div className="flex gap-[12px] md:gap-[16px] items-start md:ml-auto">
                <a
                  ...
                  className="bg-[#fffbfa] flex gap-[8px] items-center justify-center px-[16px] md:px-[24px] py-[10px] md:py-[12px] rounded-[100px] hover:bg-[#f5f0ef] transition-colors cursor-pointer border border-[rgba(120,120,128,0.16)]"
                >
